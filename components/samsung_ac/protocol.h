...
namespace esphome
{
    namespace samsung_ac
    {
        ...
        public:
            ...
            virtual void set_outdoor_discharge_temperature(const std::string address, float value) = 0;
            virtual void set_outdoor_condenser_mid_temperature(const std::string address, float value) = 0;
